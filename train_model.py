...
model = LearningAlgorithm(config_file=cfg_file)
...
model.generate(audio_orig=audio_1, audio_recon=audio_1_recon, state_dict_file=state_file)

score_rmse, score_pesq, score_stoi = model.eval(audio_ref=audio_1, audio_est=audio_1_recon, metric='all', state_dict_file=state_file)
# score_rmse = model.eval(audio_ref=audio_1, audio_est=audio_1_recon, metric='rmse', state_dict_file=state_file)
