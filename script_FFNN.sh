...
#export PATH="/scratch/octans/sileglai/miniconda3/bin:$PATH"
export PATH="/scratch/virgo/xbie/anaconda3/envs/rvae/bin:$PATH"

#cd /scratch/octans/sileglai/recherche/python/speech_enhancement/SE_FFNN_RNN_VAEs_pytorch/training/
cd /scratch/virgo/xbie/Code/VAEs_pytorch/

python train_FFNN_WSJ0.py
